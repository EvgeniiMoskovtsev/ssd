...
if __name__ == '__main__':
    ...
    cap = cv2.imread('/home/evg/Documents/TSURU/Aura/data/Dataset_to_train/NEW_SET_23_SEPTEMBER/second/3-20201006T095000Z-001/3/1026.png')
    ...
    while True:
        ...
        draw_image = detect(frame, min_score=0.5, max_overlap=0.7, top_k=200)
